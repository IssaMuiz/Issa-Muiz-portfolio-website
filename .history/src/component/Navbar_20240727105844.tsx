...
const Navbar = () => {
  return (
    <div>
      ...
      <div className="fixed bottom-0 top-10 right-0 bg-[#080808] flex-col text-white mt-40 backdrop-blur-sm  bg-opacity-30 pr-32 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 gap-8">
        <div className="">
