...
const Navbar = () => {
  return (
    <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mx-5 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20 z-10">
      <div className="">
        <Link to="/">
      ...
      <div className="mr-10">
        ...
        <div>
          ...
          <div className="flex flex-col text-white mt-40 backdrop-blur-sm bg-[#080808] bg-opacity-40 pr-32 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 gap-3">
            <div className="">
              <div className="hover:text-[#fc5c06] hover:border-b hover:border-[#fc5c06] pr-32 z-10">
                <Link to="/">Home</Link>
              </div>
