...
const Navbar = () => {
  return (
    <div>
      ...
      <div className="fixed top-0 right-0 mt-20 bg-[#080808] flex-col text-white text-xl backdrop-blur-sm  bg-opacity-30 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 gap-8">
