    ...
    <div>
      <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mx-5 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20">
        ...
        <div className="mr-10">
          ...
          <div>
            <svg
              className="fill-[#c74804] tablet:hidden desktop:hidden mobile:block cursor-pointer"
      ...
      <div>
        {navbar && (
          <div className="fixed top-0 right-0 mt-20 bg-[#080808] flex-col text-white text-xl f backdrop-blur-lg  bg-opacity-30 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 z-40 gap-8">
            <p className="text-end pr-4 mb-2 hover:text-[#fc5c06] cursor-pointer">
              X
            </p>
            <div className="">
              <div className="hover:text-[#fc5c06] hover:border-b hover:border-[#fc5c06] pr-44 pb-2">
                <Link to="/">Home</Link>
              </div>
