...
const Navbar = () => {
  return (
    <div className="fixed bg-black bg-opacity-30 backdrop-blur-sm flex justify-between items-center text-xl top-0 left-0 bottom-0  w-full h-20">
      <Link to="/">
      ...
      <div className="text-white flex gap-5 mobile:hidden tablet:block">
        <Link
          to="/"
