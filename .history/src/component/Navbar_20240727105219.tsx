    ...
    <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mx-5 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20">
      ...
      <div className="mr-10">
        ...
        <div>
          ...
          <div className="fixed bottom-0 right-0 top-10 bg-[#080808] flex-col text-white mt-40 backdrop-blur-sm  bg-opacity-30 pr-32 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 gap-8">
            <div className="">
