    ...
    <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mx-5 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20 z-10">
      ...
      <div className="mr-10">
        ...
        <div>
          ...
          <div className="flex flex-col text-white mt-40 backdrop-blur-sm bg-[#080808] bg-opacity-40 p-10 gap-2">
            <div className="hover:text-[#fc5c06] hover:border-b hover:border-[#fc5c06] w-full">
              <Link to="/">Home</Link>
            </div>
            <div>
