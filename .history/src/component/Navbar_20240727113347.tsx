...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div>
        {navbar && (
          <div className="fixed top-0 right-0 mt-20 bg-[#080808] flex-col text-white text-xl f backdrop-blur-lg  bg-opacity-30 border-2 border-[#fc5c06] px-2 rounded-lg py-5 z-40">
            <p
