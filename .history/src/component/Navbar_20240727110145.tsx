...
const Navbar = () => {
  return (
    <div>
      <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mx-5 backdrop-blur-sm flex justify-evenly items-center text-xl z-10 top-0 left-0 bottom-0  w-full h-20">
        <div className="">
          <Link to="/">
      ...
      <div className="fixed top-0 right-0 mt-10 bg-[#080808] flex-col text-white backdrop-blur-sm  bg-opacity-30 pr-32 border-2 border-[#fc5c06] pl-2 rounded-lg py-5 gap-8">
        <div className="">
