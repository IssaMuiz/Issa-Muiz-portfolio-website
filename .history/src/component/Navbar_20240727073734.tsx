...
const Navbar = () => {
  return (
    <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mr-2 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20">
      <div>
        <Link to="/">
