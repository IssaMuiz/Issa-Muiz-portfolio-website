const Project = () => {
  return (
    <div className="pt-40">
      <div className="font-bold rounded-lg text-center text-3xl h-[420px] w-72 m-auto bg-black text-white cursor-pointer border-2 border-[#fc5c06]  ">
        <div>
          <img className="px-2" src="assets/online community app.jpg" alt="" />
          <p>Project 1</p>
