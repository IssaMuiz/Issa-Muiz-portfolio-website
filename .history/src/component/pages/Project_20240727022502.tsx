const Project = () => {
  return (
    <div className="pt-40 flex justify-start">
      <div className="font-bold  rounded-lg text-center text-3xl h-[420px] w-80 m-auto bg-black text-white cursor-pointer border-2 border-[#fc5c06]  ">
        <div>
          <img
            className="px-2 pt-2"
