const Project = () => {
  return (
    <div className="pt-40 flex justify-center gap-5">
      <div className="font-bold rounded-lg text-center text-3xl h-[440px] w-80 bg-black hover:-translate-y-2 hover:font-bold text-white cursor-pointer border-2 border-[#fc5c06]  ">
        <div className="mt-2 ">
          <img
