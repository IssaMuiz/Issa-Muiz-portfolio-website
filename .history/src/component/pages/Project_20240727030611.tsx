const Project = () => {
  return (
    <div className="pt-20">
      <h1 className="text-white font-bold text-5xl  text-center ">Services</h1>
      <div className=" flex mt-16 justify-center gap-5">
        <div className="font-bold rounded-lg text-center text-3xl h-[440px] w-80 bg-black hover:-translate-y-2  text-white cursor-pointer border-2 border-[#fc5c06]  ">
          <div className="mt-2 ">
            <img
            ...
            <p className="text-white text-[15px] font-normal leading-5 mt-2">
              ...
              Taiwind CSS, Firebase for authentication of users
            </p>
            <button className="bg-[#fc5c06] font-normal hover:bg-[#e05103] rounded-3xl text-sm p-2 mt-7">
              Review Project
            </button>
          </div>
        </div>
        <div className="font-bold  rounded-lg text-center hover:-translate-y-2 text-3xl h-[440px] w-80 bg-black text-white cursor-pointer border-2 border-[#fc5c06]  ">
          <div className="mt-2">
            <img
              className="px-2 pt-2 rounded-xl"
