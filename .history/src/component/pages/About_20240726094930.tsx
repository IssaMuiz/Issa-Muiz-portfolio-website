      ...
      <div className="flex pt-40 justify-center items-center m-auto gap-10">
        ...
        <div>
          <div className="text-white text-lg  w-96">
            ...
            <p>{expand ? aboutText.slice(0, 152) + "......" : aboutText}</p>
            <div>
              <button
                onClick={toggleExpand}
                className="border px-2 text-sm rounded-xl bg-[#fa5801] hover:bg-[#b34002] mt-2"
              >
