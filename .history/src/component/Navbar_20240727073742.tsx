...
const Navbar = () => {
  return (
    <div className="fixed bg-black bg-opacity-30  mobile:justify-between mobile:mr-10 backdrop-blur-sm flex justify-evenly items-center text-xl top-0 left-0 bottom-0  w-full h-20">
      <div>
        <Link to="/">
      ...
      <div className="text-white flex gap-2 mobile:hidden tablet:flex">
        <div>
          <Link
            to="/"
      ...
      <div>
        <svg
          className="fill-[#c74804] tablet:hidden  mobile:block"
