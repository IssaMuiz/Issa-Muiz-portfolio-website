  ...
  return (
    <div>
      <div className="pt-20">
        ...
        <div className="font-bold mt-16 rounded-lg text-center text-3xl h-96 w-72 m-auto bg-[#fc5c06] cursor-pointer hover:border-2 hover:bg-black hover:text-[#fc5c06] hover:border-[#fc5c06] hover:shadow-custom">
